...
namespace SpyMod.Spy.Content
{
    public static class SpyAssets
    {
        ...
        private static void CreateEffects()
        {
            ...
            bloodExplosionEffect.GetComponentInChildren<PostProcessVolume>().sharedProfile = Addressables.LoadAssetAsync <PostProcessProfile>("RoR2/Base/title/PostProcessing/ppLocalGold.asset").WaitForCompletion();
        ...
        {
            using (Stream manifestResourceStream2 = Assembly.GetExecutingAssembly().GetManifestResourceStream("SpyMod.spy_bank.bnk"))
            {
        ...
        {
            defaultCrosshair = CharacterAssets.LoadCrosshair("Standard");
            watchCrosshair = CharacterAssets.LoadCrosshair("SimpleDot");
